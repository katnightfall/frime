Locales['en'] = {
    ...
    purchaseconfirmcoin = 'Do you want to purchase this house for %s coin?',
    ...
    buyhousedesccoin = "Price: %s Coin | Capacity: %skg",
    renthouse = "Rent House",
    renthousedesc = "Price: $%s/week(prepaid) | Capacity: %skg",
    renthousedesccoin = "Price: %s Coin/week(prepaid) | Capacity: %skg",
    rentconfirm = 'Do you want to rent this house for $%s',
    rentconfirmcoin = 'Do you want to rent this house for %s coin',

    installmenthouse = "Buy On Installment",
    installmenthousedesc = "Pay: $%s/week | Down Payment: $%s | Capacity: %skg | Installments: x%s",
    installmenthousedesccoin = "Pay: %s Coin/week | Down Payment: %s Coin | Capacity: %skg | Installments: x%s",
