Citizen.CreateThread(function()
	if Config.Wardrobe.script == 'auto' then
		...
		if GetResourceState('rcore_clothing') == 'started' or GetResourceState('rcore_clothing') == 'starting' then
			Config.Wardrobe.script = 'rcore_clothing'
			return
		end
...
AddEventHandler('ak47_qb_housing:openwardrobe', function(houseid, objectid)
	...
	elseif Config.Wardrobe.script == 'rcore_clothing' then
