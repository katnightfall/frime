...
local function UpdateOfficerBlips(officers, getCallsign, getAvatar, event)
    ...
    for i = 1, #officers do
        ...
        officer.callsign = getCallsign(officer.identifier, true)
    ...
    for i = 1, #officers do
        ...
        TriggerLatentClientEventInternal(event, officers[i].source, payload, length, -1)
    end
end
...
while true do
    ...
    -- debugprint(("Duty blips update took %dms"):format(elapsed))
