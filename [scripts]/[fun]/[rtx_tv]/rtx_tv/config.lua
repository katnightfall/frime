...
Config.CustomTvCreator = false -- enable this only on dev server, its for create a custom 3d renderer screen via our ingame creator - command is /createcustomtv for custom 3d renderer screen and /createcustomtv objectname for place a tv object
