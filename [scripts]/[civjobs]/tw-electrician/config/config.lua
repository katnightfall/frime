Config                       = {}
Locales                      = Locales or {}
Config.Framework             = 'qb'      -- esx, oldesx, qb, oldqb - vrp qb = qbox -- || type qb if you are using qbox
Config.Locale                = 'en'
Config.CurrencyUnit          = '$'       -- '€' -- '₺'  '$'
...
Config.Command               = {
    jobReset = "jobresetelectrician",
    jobLeave = "jobleaveelectrician",
    -- openTutorial = "openTutorialelectrician",
}
    ...
    ['regionData'] = {
        {
            ...
            regionJobVehicle = {
                vehicle = "utillitruck2",
                vehicle2 = 'utillitruck3',
            },
            vehicleSpawnCoords = {
