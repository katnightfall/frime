...
Config.SetPlayersRadios = true -- Set the player's radios to the team radios when the game starts
...
Config.EnableGTA5Crosshair = true  -- Make this false if you do not want to enable the gta 5 default crosshair inside of paintball matches.
...
CreateThread(function()
    ...
    if GetResourceState('nuketown-arena') == 'started' then
        Config.Arenas["Narena"] = {
            ...
            icon = "fa-radiation",
            ZoneCenter = vector3(-3259.86, 7011.37, 637.58),
            Radius = 75.0,
            iconColor = "#f1f120ff" -- red
        }
    end
    if GetResourceState('nuketown-mirrorpark') == 'started' then
        Config.Arenas["NMpark"] = {
            ...
            icon = "fa-city",
            ZoneCenter = vector3(1383.88, -742.38, 70.06),
            Radius = 75.0,
            iconColor = "#03a9f4" -- light blue
        }
    end
...
Config.GameModes = {
    ...
    [5] = {
        name = 'Free For All',
        description = 'Every man for himself! Earn '..Config.MaxFFAScore..' kills to win!'
    },
    [6] = {
        name = 'One In The Chamber',
        description = 'You have 1 bullet, dont waste it! Every kill earns one more bullet.'
    },
    [7] = {
        name = 'Random',
    ...
    ["ArenaMain"] = {
        ['Zone'] = {
            ['Shape'] = { --polyzone that surrounds the area
                vector3(2944.2971191406, -3915.4157714844, 120.90644836426),
                vector3(2700.78125, -3920.5346679688, 120.90644836426),
                vector3(2657.9755859375, -3914.0756835938, 120.90644836426),
                vector3(2609.1960449219, -3860.6259765625, 120.90644836426),
                vector3(2584.8696289063, -3812.9060058594, 120.90644836426),
                vector3(2586.7077636719, -3763.1921386719, 120.90644836426),
                vector3(2632.6293945313, -3687.7729492188, 120.90644836426),
                vector3(2765.46484375, -3668.984375, 120.90644836426),
                vector3(2927.2419433594, -3675.6569824219, 120.90644836426),
                vector3(2998.0849609375, -3734.0246582031, 120.90644836426),
                vector3(3012.6418457031, -3811.8872070313, 120.90644836426),
                vector3(2995.7155761719, -3865.7541503906, 120.90644836426)
            },
