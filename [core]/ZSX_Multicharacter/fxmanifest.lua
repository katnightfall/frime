...
client_scripts {'client/addons/*.lua', 'client/algorithms/*.lua', 'client/errortracker/modules/*.lua', 'client/errortracker/data/*.lua', 'client/errortracker/*.lua', 'client/framework/*.lua', 'client/functions/*.lua', 'client/cl_main.lua', 'client/cl_baseevents.lua', 'client/cl_identity.lua',  'client/cl_worker.lua',  'client/cl_config.lua'}
server_scripts {
